...
public final class ModConstants {
    ...
    public static final String FIRMACIV = "firmaciv";
    public static final String FIRMALIFE = "firmalife";
    public static final String PRECISION_PROSPECTING = "precisionprospecting";
    public static final String TFC_AMBIENTAL = "tfcambiental";
    public static final String TFC_CAST_IRON_GRILL = "castirongrill";
    public static final String TFC_CASTING_WITH_CHANNELS = "tfcchannelcasting";
    public static final String TFC_THERMAL_DEPOSITS = "tfcthermaldeposits";
