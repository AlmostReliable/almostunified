...
public final class AlmostKube {
    ...
    public static Set<String> getTagEntries(Identifier tag) {
    ...
    public static ItemStack getTagTargetItem(Identifier tag) {
        var tagKey = TagKey.create(Registries.ITEM, tag);
    ...
    private static Identifier getId(ItemStack stack) {
