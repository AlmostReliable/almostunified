 ...
 */
public record ClientRecipeTracker(String namespace, Map<Identifier, ClientRecipeLink> recipes)
    implements Recipe<RecipeInput> {

    public static final Identifier ID = Utils.getRL("client_recipe_tracker");
    ...
    @Nullable
    public ClientRecipeLink getLink(Identifier recipeId) {
        return recipes.get(recipeId);
    }

    public record ClientRecipeLink(Identifier id, boolean isUnified, boolean isDuplicate) {}
    ...
    public static class RawBuilder {
         ...
         */
        public Map<Identifier, JsonObject> compute() {
