...
public final class AlmostUnifiedRuntimeImpl implements AlmostUnifiedRuntime {
    ...
    private AlmostUnifiedRuntimeImpl(
        Collection<? extends UnificationSettings> unificationSettings, CustomIngredientUnifierRegistry ingredientUnifierRegistry,
        RecipeUnifierRegistry recipeUnifierRegistry, TagSubstitutions tagSubstitutions, Placeholders placeholders, DebugConfig debugConfig
    ) {
     ...
     */
    private static Set<TagKey<Item>> bakeAndValidateTags(
        Collection<UnificationConfig> unificationConfigs, VanillaTagWrapper<Item> itemTags, Placeholders placeholders,
        boolean logInvalidTags
    ) {
        ...
        if (!wrongTags.isEmpty() && logInvalidTags) {
            AlmostUnifiedCommon.LOGGER.warn(
                "The following tags are invalid or not in use and will be ignored: {}",
     ...
     */
    private static List<UnificationSettings> createUnificationLookups(
        VanillaTagWrapper<Item> itemTags, VanillaTagWrapper<Block> blockTags, Collection<UnificationConfig> unificationConfigs,
        TagSubstitutionsImpl tagSubstitutions, TagInheritance tagInheritance
    ) {
        var unificationSettings = UnificationSettingsImpl.create(
            unificationConfigs,
            itemTags,
            blockTags,
            tagSubstitutions
    ...
    public void run(Map<Identifier, JsonElement> recipes, RecipeManager recipeManager) {
