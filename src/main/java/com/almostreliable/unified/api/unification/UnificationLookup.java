...
public interface UnificationLookup {
     ...
     */
    @Nullable
    UnificationEntry<Item> getItemEntry(Identifier item);
     ...
     */
    @Nullable
    TagKey<Item> getRelevantItemTag(Identifier item);
     ...
     */
    @Nullable
    UnificationEntry<Item> getVariantItemTarget(Identifier item);
     ...
     */
    @Nullable
    UnificationEntry<Item> getTagTargetItem(TagKey<Item> tag, Predicate<Identifier> itemFilter);
