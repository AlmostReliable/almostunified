...
public final class SmithingRecipeUnifier implements RecipeUnifier {
    ...
    public static final Identifier TRANSFORM_TYPE = Identifier.withDefaultNamespace("smithing_transform");
    public static final Identifier TRIM_TYPE = Identifier.withDefaultNamespace("smithing_trim");
