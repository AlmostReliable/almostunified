...
public interface UnificationHelper {
     ...
     *
     * @param type the value of the type property of the {@link JsonObject} as a {@link Identifier}
     * @return the {@link CustomIngredientUnifier} or null if no custom unifier is associated with the given type
     *
     * @since 1.2.0
     */
    @Nullable
    CustomIngredientUnifier getCustomIngredientUnifier(Identifier type);
