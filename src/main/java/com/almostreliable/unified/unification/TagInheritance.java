...
public class TagInheritance {
    ...
    public TagInheritance(
        Mode itemMode, Map<TagKey<Item>, Set<Pattern>> itemInheritance, Mode blockMode, Map<TagKey<Block>, Set<Pattern>> blockInheritance) {
        itemOptions = new Options<>(itemMode, itemInheritance);
        blockOptions = new Options<>(blockMode, blockInheritance);
    }

    public boolean apply(
        VanillaTagWrapper<Item> itemTags, VanillaTagWrapper<Block> blockTags, List<? extends UnificationLookup> unificationLookups) {
        Multimap<UnificationEntry<Item>, Identifier> changedItemTags = HashMultimap.create();
        Multimap<UnificationEntry<Item>, Identifier> changedBlockTags = HashMultimap.create();
    ...
    private Holder<Block> findTargetBlockHolder(VanillaTagWrapper<Block> tagMap, UnificationEntry<Item> targetItem) {
        ...
        return BuiltInRegistries.BLOCK.getOrThrow(ResourceKey.create(Registries.BLOCK, targetItem.id()));
    }

    private Set<Identifier> applyItemTags(
        VanillaTagWrapper<Item> vanillaTags, Holder<Item> targetItem, Set<TagKey<Item>> targetItemTags, UnificationEntry<Item> item) {
    ...
    private Set<Identifier> applyBlockTags(
        VanillaTagWrapper<Block> blockTagMap, Holder<Block> targetBlock, Set<TagKey<Item>> targetItemTags, UnificationEntry<Item> item) {
    ...
    private record TagRelation(
        TagKey<Item> tag, UnificationEntry<Item> targetItem,
