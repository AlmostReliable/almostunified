...
public class RecipeUnifierRegistryImpl implements RecipeUnifierRegistry {
    ...
    private final Map<Identifier, RecipeUnifier> recipeUnifiersByRecipeType = new HashMap<>();
    private final Map<String, RecipeUnifier> recipeUnifiersByModId = new HashMap<>();

    @Override
    public void registerForRecipeType(Identifier recipeType, RecipeUnifier recipeUnifier) {
