...
public final class DebugHandler {
    ...
    private final Set<Identifier> recipeErrors = new HashSet<>();
    ...
    public void onRunStart(Map<Identifier, JsonElement> recipes, UnificationLookup unificationLookup) {
    ...
    public void onRunEnd(Map<Identifier, JsonElement> recipes) {
    ...
    public void collectRecipeError(Identifier recipeId) {
        Preconditions.checkNotNull(transformerResult, "transformerResult not set");
    ...
    private void dumpRecipes(String fileName, Map<Identifier, JsonElement> recipes) {
    ...
    private Stream<Identifier> getSortedUnifiedRecipeTypes() {
    ...
    private Stream<RecipeLink> getSortedUnifiedRecipes(Identifier type) {
        Preconditions.checkNotNull(transformerResult);
        return transformerResult
